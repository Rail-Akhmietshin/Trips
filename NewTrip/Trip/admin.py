...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('number_phone', 'username', 'email', 'last_login', 'is_admin', 'is_active','is_confirmation')
    list_filter = ('is_admin',)
    fieldsets = (
        (None, {'fields': ('number_phone', 'password')}),
        ('Personal info', {'fields': ('username', 'email', 'last_login')}),
        ('Permissions', {'fields': ('is_admin', 'is_active', 'is_confirmation')}),
    )
    ...
    search_fields = ('number_phone', 'username', 'email')
    ordering = ('id',)
    filter_horizontal = ()
